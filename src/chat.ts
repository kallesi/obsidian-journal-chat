	...
	async onOpen() {
        ...
        stopButton.addEventListener("click", () => {
            if (this.isStreaming) {
                ...
                const thinkingMessage = messageContainer.querySelector(".animated-dots");
                if (thinkingMessage) {
        ...
        input.addEventListener("keypress", async (event) => {
            if (event.key === "Enter") {
                ...
                if (message.trim()) {
                    if (
                        (message.trim() === "/c" || message.trim() === "/clear") &&
                        !this.isStreaming
                    ) {
                        ...
                        if (notesData) {
                            ...
                            if (
                                ...
                                this.messages[0].content.startsWith("These are my journals")
                            ) {
                        ...
                        const thinkingMessage = this.addMessage(messageContainer, "Chatbot", "");
